...
import { categorySchema, CreateCategoryFormType } from '@module/category/utils/schema'
...
interface UpdateCategoryComponentProps {
    data: CreateCategoryFormType
}

    
const UpdateCategoryComponent: React.FC<UpdateCategoryComponentProps> = ({ data }) => {

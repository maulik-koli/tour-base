...
const HeroSection: React.FC = () => {
    return (
        <section className="bg-card relative w-full px-20 min-h-[calc(100svh-4rem)] h-[calc(100svh-4rem)]">
            ...
            <div className="relative z-10 flex flex-col gap-8 items-center justify-center h-full text-center px-4">
                ...
                <Typography variant='h4' className="max-w-lg text-primary-foreground/80">

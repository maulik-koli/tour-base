...
const TourPackageSide: React.FC = () => {
    return (
         <div className='w-full p-5 border border-border rounded-lg bg-card'>
            ...
            <div className='space-y-4'>
                {DUMMY_PACKAGE.map((pkg, index) => (
                    <div key={`package-${index}`} className={cn(
                        ...
                        <div className='space-y-2'>
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <Typography variant="p" className='font-semibold'>{pkg.days} Days / {pkg.nights} Nights</Typography>
                            </div>
                            <div className='flex items-center justify-between'>
                                <Typography variant="p">Route</Typography>
                                <Typography variant="p" className='font-semibold'>{pkg.start} - {pkg.endCity}</Typography>
                            </div>
                        </div>
                    </div>
                ))}
